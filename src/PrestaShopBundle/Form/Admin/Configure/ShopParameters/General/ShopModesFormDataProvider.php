 ...
 */
final class ShopModesFormDataProvider implements FormDataProviderInterface
{
    public function __construct(
        private readonly ShopModesConfiguration $shopModesConfiguration,
    ) {
    }
    ...
    {
        return $this->shopModesConfiguration->getConfiguration();
    }
    ...
    {
        return $this->shopModesConfiguration->updateConfiguration($data);
    }
}
