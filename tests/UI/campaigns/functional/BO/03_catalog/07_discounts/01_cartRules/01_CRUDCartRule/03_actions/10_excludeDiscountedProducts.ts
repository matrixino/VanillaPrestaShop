...
const baseContext: string = 'functional_BO_catalog_discounts_cartRules_CRUDCartRule_actions_excludeDiscountedProducts';

describe('BO - Cart rules - Actions : Exclude discounted products', async () => {
  let browserContext: BrowserContext;
  let page: Page;

  const cartRuleData: FakerCartRule = new FakerCartRule({
    name: 'Cart Rule Discount Exclude discounted products',
    description: 'It is a test for cart rules',
    code: 'CRDExcludeDiscountedProducts',
